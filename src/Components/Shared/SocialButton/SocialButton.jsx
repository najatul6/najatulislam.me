...
const SocialButton = ({icon,link,text}) => {
  return (
    ...
    <button className="shadow-in duration-300 ease-in-out rounded-full text-2xl font-bold p-3 hover:shadow-up hover:text-blue-light active:shadow-in active:text-blue-light">
        {icon}
    </button>
